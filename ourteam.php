...
<html lang="en">
  ...
  <div class="container">
    <div class="container-work">
      <div class="post">
        <h2 class="text-center">Advisor</h2>
      </div>
      <div class="row">
        <div class="col-sm-4">
          <div class="hover workpanel" onmouseover="javascript:this.className += ' flip';" onmouseout="javascript:this.className = 'hover workpanel';">
            <div class="front">
                <div class="frontLogo">
                  <img class="img-responsive" src="images/demo.png">
                </div>
    ...
    <div class="container-work">
      <div class="row">
        <div class="col-sm-4">
          <div class="post">
            <h2 class="text-center">Motivator</h2>
          </div>
          <div class="hover workpanel" onmouseover="javascript:this.className += ' flip';" onmouseout="javascript:this.className = 'hover workpanel';">
            <div class="front">
                <div class="frontLogo">
    ...
    <hr>
      <div class="post">
        <h2 class="text-center">Top Post Holders 2017</h2>
      </div>
      <div class="row space">
        <div class="col-sm-3">
          <div class="hover workpanel" onmouseover="javascript:this.className += ' flip';" onmouseout="javascript:this.className = 'hover workpanel';">
