...
<html lang="en">
  <head>
    ...
    <title>AIUB Community of Engineering Students-ACES</title>
    <!-- Icon -->
  ...
  <body>
      		...
      		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      		  <ul class="nav navbar-nav my-nav">
      		    <li><a href="index.html">Home</a></li>
      		        ...
      		        <li><a href="#our-projects">Our Works</a></li>
    ...
    <footer class="my-footer-full no-pad">
      ...
      <div class="container-fluid">
            <div class="row">
                    ...
                    <!-- Middle Col -->
                    <div class="col-sm-4 col-xs-12 contact" id="contact">
                      <div class="logo">
                        <img class="img-responsive" src="images/logo2.png"></img>
                      </div>
                      <div class="contact-us">
                        <h3 class="text-center"><strong>AIUB Community of Engineering Students</strong></h3>
                        <div class="text-center"><p class="phone"><strong><i class="fa fa-phone" aria-hidden="true"></i>(+88)01**********</strong></p> </div>
                        <div class="text-center">
                    ...
                    <!-- Last Col -->
                    <div class="col-sm-4 col-xs-12 feedback">
                        <h2 class="text-center"><strong>Give Us Feedback</strong></h2>
