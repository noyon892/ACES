...
<html lang="en">
  ...
  <body>
    ...
    <!-- Our Mission -->
    <div class="container about" id="promo-mission">
      <div class="row">
          ...
          <h1 class="text-center"><strong>Our Vision</strong></h1>  
            ...
            <strong>
              <p class="text-justify">
                To be a professional student organization in providing excellent welfare and services as well as acquiring academic excellence for students of Faculty of Engineering. ACES also envision a world in which the communities we serve have the capacity to sustainably meet their basic human needs and that our members have enriched global perspectives through the innovative professional educational opportunities that the ACES provides.
              </p>
            </strong>
        </div>
        <div class="col-sm-6 promo-image">
